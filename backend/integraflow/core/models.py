...
class SortableModel(models.Model):
    sort_order: models.IntegerField = models.IntegerField(
        editable=False, db_index=True, null=True
    )
...
class EventDelivery(models.Model):
    ...
    payload: models.ForeignKey = models.ForeignKey(
        EventPayload,
...
class EventDeliveryAttempt(models.Model):
    ...
    created_at: models.DateTimeField = models.DateTimeField(auto_now_add=True)
    task_id: models.CharField = models.CharField(max_length=255, null=True)
    duration: models.FloatField = models.FloatField(null=True)
    response: models.TextField = models.TextField(null=True)
    response_headers: models.TextField = models.TextField(null=True)
    response_status_code: models.PositiveSmallIntegerField = (
        models.PositiveSmallIntegerField(null=True)
    )
    request_headers: models.TextField = models.TextField(null=True)
    status: models.CharField = models.CharField(
        max_length=255,
        choices=EventDeliveryStatus.CHOICES,
        default=EventDeliveryStatus.PENDING,
