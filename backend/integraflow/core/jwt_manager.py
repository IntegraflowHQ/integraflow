...
class JWTManager(JWTManagerBase):
    ...
    def get_key_id(cls) -> str:
        ...
        This generates a "thumbprint" as 'kid' field using RFC 7638
        implementation based on the RSA public key.
        """
    ...
    def validate_configuration(cls):
        if not settings.RSA_PRIVATE_KEY:
            if not settings.DEBUG:
                ...
                msg = (
                    "RSA_PRIVATE_KEY is missing. Using temporary key for "
