...
SENSITIVE_HEADERS is a set of lowercase HTTP headers to anonymize before
reporting.

SENSITIVE_GQL_FIELDS is a dict of sets representing fields of GraphGL types to
anonymize
