"""Form fields converter subset from graphene_django for use in Integraflow."""
...
def convert_form_field(field):
    raise ImproperlyConfigured(
        f"Don't know how to convert the Django form field {field} "
        "({field.__class__}) to Graphene type"
    )
