...
An operation for each query and mutation in the Integraflow API containing:
...
1. The GraphQL schema is parsed using a reusable [ContextVisitor](./src/context-visitor.ts) to provide consistent information across the Integraflow code generator plugins
