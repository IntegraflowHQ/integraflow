...
import { CTASettings, CTAType, Question, SurveyAnswer, Theme } from "../../types";
        ...
        onAnswered([
            {
                ...
                ctaSuccess: true,
                ctaType: (question?.settings as CTASettings).type,
                answer: "Action performed"
            }
        ]);
    };
    ...
    return (
        <div className={"min-w-[255px] space-y-3"}>
            ...
            {(question?.settings as CTASettings).type === CTAType.HIDDEN ? null : (
                <Button onClick={onClickHandler} size="full" color={theme?.button}>
