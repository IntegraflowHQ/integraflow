...
import { AngryEmoji, HappyEmoji, NeutralEmoji, SadEmoji, SatisfiedEmoji } from "../../assets";
...
const smileyOptions = [<AngryEmoji />, <SadEmoji />, <NeutralEmoji />, <SatisfiedEmoji />, <HappyEmoji />];
...
export const SmileyResponse = ({ question, label, description, theme, onAnswered }: Props) => {
    ...
    return (
        <AnswerContainer>
            <Header title={label ?? ""} description={description} color={theme?.question ?? "#050505"} />
