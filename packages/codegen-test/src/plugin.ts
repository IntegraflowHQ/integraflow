...
import { ContextVisitor, logger, PluginContext, printLines } from "@integraflow/codegen-doc";
import { ModelVisitor, parseOperations, Sdk, SdkModel, SdkPluginConfig, SdkPluginContext } from "@integraflow/codegen-sdk";
...
/**
 * Graphql-codegen plugin for outputting the typed Integraflow documents
 */
