...
export const INTEGRAFLOW_WEBHOOK_SIGNATURE_HEADER = "integraflow-signature";
export const INTEGRAFLOW_WEBHOOK_TS_FIELD = "webhookTimestamp";

/**
 * Provides helper functions to work with Integraflow webhooks
 */
export class IntegraflowWebhooks {
