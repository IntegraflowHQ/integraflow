...
export const MemberList = ({ searchValue }: Props) => {
    ...
    const { removeOrganizationMember, leaveOrganization, updateMemberRole } = useWorkspaceInvite();
                            ...
                            <div className="flex items-center justify-between px-2 py-3">
                                ...
                                <div className="font-sm basis-[20%] lowercase">
                                    ...
                                    {member?.node?.email === user.email ? (
                                        <span className="rounded-md bg-yellow-200 p-1 text-xs">YOU</span>
                                    ) : null}
                                </div>
                                <DropdownMenu.Root>
                                    ...
                                    <DropdownMenu.Portal>
                                        ...
                                        >
                                            {(isOwner || isAdmin) && member?.node?.role !== RoleLevel.Owner && (
                                                <DropdownMenu.Item
