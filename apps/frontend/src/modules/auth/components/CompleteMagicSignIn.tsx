...
export default function CompleteMagicSignIn() {
    ...
    const [resendMagicLink, {loading: isResendingMagicLink}] = useEmailUserAuthChallengeMutation({
    ...
    const [verifyToken, {loading: isVerifyingToken}] = useEmailTokenUserAuthMutation({
        onCompleted: ({ emailTokenUserAuth }) => {
            if (
    ...
    if (isVerifyingToken || isResendingMagicLink) {
    ...
    return (
        <Screen>
            <section className="mx-auto flex w-[406px] flex-col items-center">
                <img src={CheckInbox} className="object-cover object-top h-56 w-80" />
                            ...
                            >
                                <form className="flex flex-col gap-3" onSubmit={handleSubmit(onSubmit)}>
                                    <TextInput
                                        ...
                                        {...register("code", {
                                            required: {value: true, message: "Enter your code"},
                                            minLength: {value: 11, message: "Code must be 11 characters long"}
                                        })}
