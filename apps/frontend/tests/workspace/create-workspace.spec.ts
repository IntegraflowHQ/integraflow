...
test.describe("Create workspace", () => {
    ...
    test("should allow specifying workspace URL", async ({ page }) => {
        await page.locator('[name="workspaceName"]').fill(faker.word.words(2));
